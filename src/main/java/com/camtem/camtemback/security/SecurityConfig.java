...
public class SecurityConfig {
    ...
    private CorsConfigurationSource corsConfigurationSource() {
        ...
        corsConfiguration.setAllowedOrigins(Arrays.asList("http://camtem-aws-fe.s3-website.ap-northeast-2.amazonaws.com","http://camtem-aws-fe.s3-website.ap-northeast-2.amazonaws.com/productlist")); // S3 엔드포인트 설정
